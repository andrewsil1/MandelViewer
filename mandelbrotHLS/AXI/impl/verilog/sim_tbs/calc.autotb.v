...
`define AUTOTB_TVIN_X0_V  "./c.calc.autotvin_X0_V.dat"
`define AUTOTB_TVIN_Y0_V  "./c.calc.autotvin_Y0_V.dat"
`define AUTOTB_TVIN_X1_V  "./c.calc.autotvin_X1_V.dat"
`define AUTOTB_TVIN_width_V  "./c.calc.autotvin_width_V.dat"
`define AUTOTB_TVIN_maxIter  "./c.calc.autotvin_maxIter.dat"
`define AUTOTB_TVIN_X0_V_out_wrapc  "./rtl.calc.autotvin_X0_V.dat"
`define AUTOTB_TVIN_Y0_V_out_wrapc  "./rtl.calc.autotvin_Y0_V.dat"
`define AUTOTB_TVIN_X1_V_out_wrapc  "./rtl.calc.autotvin_X1_V.dat"
`define AUTOTB_TVIN_width_V_out_wrapc  "./rtl.calc.autotvin_width_V.dat"
`define AUTOTB_TVIN_maxIter_out_wrapc  "./rtl.calc.autotvin_maxIter.dat"
`define AUTOTB_TVOUT_buf_r  "./c.calc.autotvout_buf_r.dat"
`define AUTOTB_TVOUT_buf_r_out_wrapc  "./impl_rtl.calc.autotvout_buf_r.dat"
module `AUTOTB_TOP;
