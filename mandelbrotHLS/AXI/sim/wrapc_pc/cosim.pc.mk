...
LFLAG += -L "${AUTOPILOT_ROOT}/${AUTOPILOT_MACH}/tools/systemc/lib" -lsystemc -lpthread -Wl,--stack,10485760
...
$(ObjDir)/mandel_maintb.cpp_pre.cpp.tb.o : mandel_maintb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
