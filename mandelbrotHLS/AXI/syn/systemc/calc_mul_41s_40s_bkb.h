...
// ==============================================================
#ifndef __calc_mul_41s_40s_bkb__HH__
#define __calc_mul_41s_40s_bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(calc_mul_41s_40s_bkb) {
    ...
    SC_CTOR(calc_mul_41s_40s_bkb):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
