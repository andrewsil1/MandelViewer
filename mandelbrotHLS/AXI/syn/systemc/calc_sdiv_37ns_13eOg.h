...
// ==============================================================
#ifndef __calc_sdiv_37ns_13eOg__HH__
#define __calc_sdiv_37ns_13eOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(calc_sdiv_37ns_13eOg) {
    ...
    ACMP_sdiv_seq<ID, 41, din0_WIDTH, din1_WIDTH, dout_WIDTH> ACMP_sdiv_seq_U;

    SC_CTOR(calc_sdiv_37ns_13eOg):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
