...
// ==============================================================
#ifndef __calc_mul_12ns_36sfYi__HH__
#define __calc_mul_12ns_36sfYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(calc_mul_12ns_36sfYi) {
    ...
    SC_CTOR(calc_mul_12ns_36sfYi):  ACMP_mul_us_U ("ACMP_mul_us_U") {
