...
// ==============================================================
#ifndef __calc_mul_40s_41s_dEe__HH__
#define __calc_mul_40s_41s_dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(calc_mul_40s_41s_dEe) {
    ...
    SC_CTOR(calc_mul_40s_41s_dEe):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
