...
// ==============================================================
#ifndef __calc_mul_37s_36s_cud__HH__
#define __calc_mul_37s_36s_cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(calc_mul_37s_36s_cud) {
    ...
    SC_CTOR(calc_mul_37s_36s_cud):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
