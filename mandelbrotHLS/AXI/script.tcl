...
config_export -description {Mandelbrot Calculator Core} -display_name calc -format ip_catalog -rtl verilog -use_netlist none -vendor QuickSilver -version 1.01 -vivado_optimization_level 2 -vivado_phys_opt place -vivado_report_level 0
