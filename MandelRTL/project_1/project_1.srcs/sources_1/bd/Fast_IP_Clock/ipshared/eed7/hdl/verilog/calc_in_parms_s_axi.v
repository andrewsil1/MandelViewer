...
localparam
    ...
    ADDR_IER               = 7'h08,
    ADDR_ISR               = 7'h0c,
    ADDR_SETUP_DATA_0      = 7'h10,
    ADDR_SETUP_CTRL        = 7'h14,
    ADDR_X0_V_DATA_0       = 7'h18,
    ADDR_X0_V_DATA_1       = 7'h1c,
    ADDR_X0_V_CTRL         = 7'h20,
    ADDR_Y0_V_DATA_0       = 7'h24,
    ADDR_Y0_V_DATA_1       = 7'h28,
    ADDR_Y0_V_CTRL         = 7'h2c,
    ADDR_X1_V_DATA_0       = 7'h30,
    ADDR_X1_V_DATA_1       = 7'h34,
    ADDR_X1_V_CTRL         = 7'h38,
    ADDR_WIDTH_V_DATA_0    = 7'h3c,
    ADDR_WIDTH_V_CTRL      = 7'h40,
    ADDR_MAXWIDTH_V_DATA_0 = 7'h44,
    ADDR_MAXWIDTH_V_CTRL   = 7'h48,
    ADDR_UNROLL_DATA_0     = 7'h4c,
    ADDR_UNROLL_CTRL       = 7'h50,
    ADDR_MAXITER_DATA_0    = 7'h54,
    ADDR_MAXITER_CTRL      = 7'h58,
    WRIDLE                 = 2'd0,
    WRDATA                 = 2'd1,
    WRRESP                 = 2'd2,
    WRRESET                = 2'd3,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_SETUP_DATA_0: begin
                    rdata <= int_setup[0:0];
                end
                ADDR_X0_V_DATA_0: begin
                    rdata <= int_X0_V[31:0];
                end
...
assign setup     = int_setup;
assign X0_V      = int_X0_V;
assign Y0_V      = int_Y0_V;
assign X1_V      = int_X1_V;
assign width_V   = int_width_V;
assign maxIter   = int_maxIter;
// int_ap_start
always @(posedge ACLK) begin
    if (ARESET)
        int_ap_start <= 1'b0;
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_SETUP_DATA_0)
            int_setup[0:0] <= (WDATA[31:0] & wmask) | (int_setup[0:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_X0_V_DATA_0)
            int_X0_V[31:0] <= (WDATA[31:0] & wmask) | (int_X0_V[31:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_Y0_V_DATA_0)
            int_Y0_V[31:0] <= (WDATA[31:0] & wmask) | (int_Y0_V[31:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_X1_V_DATA_0)
            int_X1_V[31:0] <= (WDATA[31:0] & wmask) | (int_X1_V[31:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_MAXITER_DATA_0)
            int_maxIter[15:0] <= (WDATA[31:0] & wmask) | (int_maxIter[15:0] & ~wmask);
    end
end
