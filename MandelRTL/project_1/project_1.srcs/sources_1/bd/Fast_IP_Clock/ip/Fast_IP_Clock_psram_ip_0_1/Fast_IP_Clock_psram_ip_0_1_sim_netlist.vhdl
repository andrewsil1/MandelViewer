...
--               c:/Users/andrewsi/Documents/GitHub/MandelViewer/MandelRTL/project_1/project_1.srcs/sources_1/bd/Fast_IP_Clock/ip/Fast_IP_Clock_psram_ip_0_1/Fast_IP_Clock_psram_ip_0_1_sim_netlist.vhdl
...
entity Fast_IP_Clock_psram_ip_0_1_AsyncPSRAM is
  port (
    ...
    \next_state19_out__0\ : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME of Fast_IP_Clock_psram_ip_0_1_AsyncPSRAM : entity is "AsyncPSRAM";
end Fast_IP_Clock_psram_ip_0_1_AsyncPSRAM;

architecture STRUCTURE of Fast_IP_Clock_psram_ip_0_1_AsyncPSRAM is
  ...
  signal ce_cycle_counter_reg : STD_LOGIC_VECTOR ( 8 downto 0 );
  ...
  signal \^next_state19_out__0\ : STD_LOGIC;
...
begin
  ...
  \next_state19_out__0\ <= \^next_state19_out__0\;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Fast_IP_Clock_psram_ip_0_1_psram_ip_v1_1_S00_AXI is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of Fast_IP_Clock_psram_ip_0_1_psram_ip_v1_1_S00_AXI : entity is "psram_ip_v1_1_S00_AXI";
end Fast_IP_Clock_psram_ip_0_1_psram_ip_v1_1_S00_AXI;

architecture STRUCTURE of Fast_IP_Clock_psram_ip_0_1_psram_ip_v1_1_S00_AXI is
  ...
  signal L : STD_LOGIC_VECTOR ( 22 downto 4 );
  signal L_0 : STD_LOGIC_VECTOR ( 23 downto 2 );
  signal \ar_wrap_size__0\ : STD_LOGIC_VECTOR ( 9 downto 2 );
  signal \aw_wrap_size__0\ : STD_LOGIC_VECTOR ( 9 downto 2 );
  signal axi_araddr0 : STD_LOGIC_VECTOR ( 23 downto 2 );
  ...
  signal axi_araddr111_out : STD_LOGIC;
  ...
  signal axi_awaddr0 : STD_LOGIC_VECTOR ( 23 downto 2 );
  ...
  signal \mem_addr_reg_n_0_[0]\ : STD_LOGIC;
  signal \mem_addr_reg_n_0_[1]\ : STD_LOGIC;
  ...
  signal \plusOp__1\ : STD_LOGIC_VECTOR ( 21 downto 1 );
  ...
  signal \NLW_axi_araddr0_carry__4_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  signal \NLW_axi_araddr0_carry__4_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal NLW_axi_araddr3_carry_O_UNCONNECTED : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_axi_awaddr0_carry__4_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  signal \NLW_axi_awaddr0_carry__4_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \axi_arlen_cntr[0]_i_1\ : label is "soft_lutpair47";
  attribute SOFT_HLUTNM of \axi_arlen_cntr[1]_i_1\ : label is "soft_lutpair47";
  ...
  attribute SOFT_HLUTNM of \axi_awlen_cntr[0]_i_1\ : label is "soft_lutpair46";
  attribute SOFT_HLUTNM of \axi_awlen_cntr[1]_i_1\ : label is "soft_lutpair46";
  attribute SOFT_HLUTNM of \axi_awlen_cntr[2]_i_1\ : label is "soft_lutpair43";
  attribute SOFT_HLUTNM of \axi_awlen_cntr[3]_i_1\ : label is "soft_lutpair37";
  attribute SOFT_HLUTNM of \axi_awlen_cntr[4]_i_1\ : label is "soft_lutpair37";
  ...
  attribute SOFT_HLUTNM of \mem_addr[22]_i_6\ : label is "soft_lutpair38";
  attribute SOFT_HLUTNM of \mem_byte_en[1]_i_2\ : label is "soft_lutpair36";
  attribute SOFT_HLUTNM of \mem_byte_en[1]_i_5\ : label is "soft_lutpair38";
...
AsyncPSRAMinst: entity work.Fast_IP_Clock_psram_ip_0_1_AsyncPSRAM
     port map (
      ...
      MEM_WEN => MEM_WEN,
      Q(22 downto 4) => L(22 downto 4),
      Q(3) => \mem_addr_reg_n_0_[3]\,
      Q(2) => \mem_addr_reg_n_0_[2]\,
      Q(1) => \mem_addr_reg_n_0_[1]\,
      Q(0) => \mem_addr_reg_n_0_[0]\,
      SR(0) => reset_p,
...
\axi_araddr0_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 1) => L_0(12 downto 10),
...
\axi_araddr0_carry__2\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 0) => L_0(16 downto 13),
...
\axi_araddr0_carry__3\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 0) => L_0(20 downto 17),
      O(3 downto 0) => axi_araddr0(21 downto 18),
...
\axi_araddr0_carry__3_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
\axi_araddr0_carry__3_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
\axi_araddr0_carry__4\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 1) => \NLW_axi_araddr0_carry__4_CO_UNCONNECTED\(3 downto 1),
      CO(0) => \axi_araddr0_carry__4_n_3\,
      CYINIT => '0',
      DI(3 downto 1) => B"000",
      DI(0) => L_0(21),
      O(3 downto 2) => \NLW_axi_araddr0_carry__4_O_UNCONNECTED\(3 downto 2),
      O(1 downto 0) => axi_araddr0(23 downto 22),
      S(3 downto 2) => B"00",
      S(1) => \axi_araddr0_carry__4_i_1_n_0\,
      S(0) => \axi_araddr0_carry__4_i_2_n_0\
    );
\axi_araddr0_carry__4_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
\axi_araddr0_carry__4_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
\axi_araddr[23]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"DD0D"
    )
        port map (
...
\axi_araddr[23]_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"4F44"
    )
        port map (
...
\axi_awaddr0_carry__3\: unisim.vcomponents.CARRY4
     port map (
      ...
      O(3 downto 0) => axi_awaddr0(21 downto 18),
...
\axi_awaddr0_carry__3_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
\axi_awaddr0_carry__3_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
\axi_awaddr0_carry__4\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 1) => \NLW_axi_awaddr0_carry__4_CO_UNCONNECTED\(3 downto 1),
      CO(0) => \axi_awaddr0_carry__4_n_3\,
      CYINIT => '0',
      DI(3 downto 1) => B"000",
      DI(0) => \axi_awaddr_reg_n_0_[21]\,
      O(3 downto 2) => \NLW_axi_awaddr0_carry__4_O_UNCONNECTED\(3 downto 2),
      O(1 downto 0) => axi_awaddr0(23 downto 22),
      S(3 downto 2) => B"00",
      S(1) => \axi_awaddr0_carry__4_i_1_n_0\,
      S(0) => \axi_awaddr0_carry__4_i_2_n_0\
    );
\axi_awaddr0_carry__4_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
\axi_awaddr0_carry__4_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
\axi_awaddr[23]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"DD0D"
    )
        port map (
...
\axi_awaddr[23]_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"4F44"
    )
        port map (
...
\mem_addr_reg[4]_i_2\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => L(4),
      S(2) => \mem_addr_reg_n_0_[3]\,
      S(1) => \mem_addr_reg_n_0_[2]\,
      S(0) => \mem_addr_reg_n_0_[1]\
    );
...
\plusOp_carry__3\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => \plusOp__1\(20 downto 17),
      S(3 downto 0) => L_0(22 downto 19)
    );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Fast_IP_Clock_psram_ip_0_1_psram_ip_v1_1 is
  port (
    mem_cen_i_reg : out STD_LOGIC;
    MEM_ADDR_OUT : out STD_LOGIC_VECTOR ( 22 downto 0 );
    MEM_OEN : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of Fast_IP_Clock_psram_ip_0_1_psram_ip_v1_1 : entity is "psram_ip_v1_1";
end Fast_IP_Clock_psram_ip_0_1_psram_ip_v1_1;

architecture STRUCTURE of Fast_IP_Clock_psram_ip_0_1_psram_ip_v1_1 is
begin
psram_ip_v1_1_S00_AXI_inst: entity work.Fast_IP_Clock_psram_ip_0_1_psram_ip_v1_1_S00_AXI
     port map (
      MEM_ADDR_OUT(22 downto 0) => MEM_ADDR_OUT(22 downto 0),
      MEM_BEN(1 downto 0) => MEM_BEN(1 downto 0),
      MEM_CRE => MEM_CRE,
...
entity Fast_IP_Clock_psram_ip_0_1 is
  ...
  attribute NotValidForBitStream of Fast_IP_Clock_psram_ip_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of Fast_IP_Clock_psram_ip_0_1 : entity is "Fast_IP_Clock_psram_ip_0_1,psram_ip_v1_1,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of Fast_IP_Clock_psram_ip_0_1 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of Fast_IP_Clock_psram_ip_0_1 : entity is "package_project";
  attribute x_core_info : string;
  attribute x_core_info of Fast_IP_Clock_psram_ip_0_1 : entity is "psram_ip_v1_1,Vivado 2019.1";
end Fast_IP_Clock_psram_ip_0_1;

architecture STRUCTURE of Fast_IP_Clock_psram_ip_0_1 is
...
U0: entity work.Fast_IP_Clock_psram_ip_0_1_psram_ip_v1_1
     port map (
      MEM_ADDR_OUT(22 downto 0) => MEM_ADDR_OUT(22 downto 0),
      MEM_BEN(1 downto 0) => MEM_BEN(1 downto 0),
      MEM_CRE => MEM_CRE,
