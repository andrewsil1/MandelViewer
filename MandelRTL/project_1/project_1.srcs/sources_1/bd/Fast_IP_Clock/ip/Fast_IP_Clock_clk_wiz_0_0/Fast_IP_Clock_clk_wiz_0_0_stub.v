...
module Fast_IP_Clock_clk_wiz_0_0(AXIclk, CalcClk, locked, clk_in1)
/* synthesis syn_black_box black_box_pad_pin="AXIclk,CalcClk,locked,clk_in1" */;
  output AXIclk;
  output CalcClk;
  output locked;
  input clk_in1;
