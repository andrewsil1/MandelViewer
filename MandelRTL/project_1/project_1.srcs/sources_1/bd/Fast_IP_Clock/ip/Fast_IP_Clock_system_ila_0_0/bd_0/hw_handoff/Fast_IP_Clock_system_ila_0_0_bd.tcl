...
################################################################
# This is a generated script based on design: bd_731d
#
...
proc create_root_design { parentCell } {
  ...
  set SLOT_2_LMB [ create_bd_intf_port -mode Monitor -vlnv xilinx.com:interface:lmb_rtl:1.0 SLOT_2_LMB ]

  set SLOT_3_LMB [ create_bd_intf_port -mode Monitor -vlnv xilinx.com:interface:lmb_rtl:1.0 SLOT_3_LMB ]
...
connect_bd_intf_net -intf_net Conn1 [get_bd_intf_ports SLOT_1_AXI] [get_bd_intf_pins g_inst/slot_1_axi]
  ...
  connect_bd_net -net SLOT_2_LMB_abus_1 [get_bd_ports SLOT_2_LMB_abus] [get_bd_pins ila_lib/probe48]
  connect_bd_net -net SLOT_2_LMB_addrstrobe_1 [get_bd_ports SLOT_2_LMB_addrstrobe] [get_bd_pins ila_lib/probe49]
  connect_bd_net -net SLOT_2_LMB_be_1 [get_bd_ports SLOT_2_LMB_be] [get_bd_pins ila_lib/probe50]
  connect_bd_net -net SLOT_2_LMB_ce_1 [get_bd_ports SLOT_2_LMB_ce] [get_bd_pins ila_lib/probe51]
  connect_bd_net -net SLOT_2_LMB_readdbus_1 [get_bd_ports SLOT_2_LMB_readdbus] [get_bd_pins ila_lib/probe52]
  connect_bd_net -net SLOT_2_LMB_readstrobe_1 [get_bd_ports SLOT_2_LMB_readstrobe] [get_bd_pins ila_lib/probe53]
  connect_bd_net -net SLOT_2_LMB_ready_1 [get_bd_ports SLOT_2_LMB_ready] [get_bd_pins ila_lib/probe54]
  connect_bd_net -net SLOT_2_LMB_ue_1 [get_bd_ports SLOT_2_LMB_ue] [get_bd_pins ila_lib/probe55]
  connect_bd_net -net SLOT_2_LMB_wait_1 [get_bd_ports SLOT_2_LMB_wait] [get_bd_pins ila_lib/probe56]
  connect_bd_net -net SLOT_2_LMB_writedbus_1 [get_bd_ports SLOT_2_LMB_writedbus] [get_bd_pins ila_lib/probe57]
  connect_bd_net -net SLOT_2_LMB_writestrobe_1 [get_bd_ports SLOT_2_LMB_writestrobe] [get_bd_pins ila_lib/probe58]
  connect_bd_net -net SLOT_3_LMB_abus_1 [get_bd_ports SLOT_3_LMB_abus] [get_bd_pins ila_lib/probe59]
  connect_bd_net -net SLOT_3_LMB_addrstrobe_1 [get_bd_ports SLOT_3_LMB_addrstrobe] [get_bd_pins ila_lib/probe60]
  connect_bd_net -net SLOT_3_LMB_ce_1 [get_bd_ports SLOT_3_LMB_ce] [get_bd_pins ila_lib/probe61]
  connect_bd_net -net SLOT_3_LMB_readdbus_1 [get_bd_ports SLOT_3_LMB_readdbus] [get_bd_pins ila_lib/probe62]
  connect_bd_net -net SLOT_3_LMB_readstrobe_1 [get_bd_ports SLOT_3_LMB_readstrobe] [get_bd_pins ila_lib/probe63]
  connect_bd_net -net SLOT_3_LMB_ready_1 [get_bd_ports SLOT_3_LMB_ready] [get_bd_pins ila_lib/probe64]
  connect_bd_net -net SLOT_3_LMB_ue_1 [get_bd_ports SLOT_3_LMB_ue] [get_bd_pins ila_lib/probe65]
  connect_bd_net -net SLOT_3_LMB_wait_1 [get_bd_ports SLOT_3_LMB_wait] [get_bd_pins ila_lib/probe66]
  ...
  connect_bd_net -net net_slot_1_axi_ar_cnt [get_bd_pins g_inst/m_slot_1_axi_ar_cnt] [get_bd_pins ila_lib/probe30]
  connect_bd_net -net net_slot_1_axi_ar_ctrl [get_bd_pins ila_lib/probe46] [get_bd_pins slot_1_ar/dout]
  connect_bd_net -net net_slot_1_axi_araddr [get_bd_pins g_inst/m_slot_1_axi_araddr] [get_bd_pins ila_lib/probe31]
  connect_bd_net -net net_slot_1_axi_arprot [get_bd_pins g_inst/m_slot_1_axi_arprot] [get_bd_pins ila_lib/probe32]
