...
#
# Generated by export_simulation on Sat Jun 08 21:39:55 -0700 2019
#
################################################################################
...
'-reset_run' switch to the './Fast_IP_Clock.sh' script.

./Fast_IP_Clock.sh -reset_run
...
./Fast_IP_Clock.sh -noclean_files

For more information on the script, please type './Fast_IP_Clock.sh -help'.
