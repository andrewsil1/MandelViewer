...
--               c:/Users/andrewsi/Documents/GitHub/MandelViewer/MandelRTL/project_1/project_1.srcs/sources_1/bd/Fast_IP_Clock/ip/Fast_IP_Clock_mii_to_rmii_0_0/Fast_IP_Clock_mii_to_rmii_0_0_sim_netlist.vhdl
-- Design      : Fast_IP_Clock_mii_to_rmii_0_0
...
entity Fast_IP_Clock_mii_to_rmii_0_0_SRL_FIFO is
  port (
  ...
  attribute ORIG_REF_NAME of Fast_IP_Clock_mii_to_rmii_0_0_SRL_FIFO : entity is "SRL_FIFO";
end Fast_IP_Clock_mii_to_rmii_0_0_SRL_FIFO;

architecture STRUCTURE of Fast_IP_Clock_mii_to_rmii_0_0_SRL_FIFO is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Fast_IP_Clock_mii_to_rmii_0_0_rmii_tx_fixed is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of Fast_IP_Clock_mii_to_rmii_0_0_rmii_tx_fixed : entity is "rmii_tx_fixed";
end Fast_IP_Clock_mii_to_rmii_0_0_rmii_tx_fixed;

architecture STRUCTURE of Fast_IP_Clock_mii_to_rmii_0_0_rmii_tx_fixed is
  ...
  attribute SOFT_HLUTNM of rmii2mac_tx_clk_bi_i_1 : label is "soft_lutpair5";
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Fast_IP_Clock_mii_to_rmii_0_0_rmii_rx_fixed is
  port (
    Reset : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of Fast_IP_Clock_mii_to_rmii_0_0_rmii_rx_fixed : entity is "rmii_rx_fixed";
end Fast_IP_Clock_mii_to_rmii_0_0_rmii_rx_fixed;

architecture STRUCTURE of Fast_IP_Clock_mii_to_rmii_0_0_rmii_rx_fixed is
  ...
  attribute SOFT_HLUTNM of rmii2mac_col_i_2 : label is "soft_lutpair4";
begin
  Q(0) <= \^q\(0);
  Reset <= \^reset\;
...
\RX_100_MBPS.I_SRL_FIFO\: entity work.Fast_IP_Clock_mii_to_rmii_0_0_SRL_FIFO
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Fast_IP_Clock_mii_to_rmii_0_0_mii_to_rmii is
  port (
    rst_n : in STD_LOGIC;
    ref_clk : in STD_LOGIC;
  ...
  attribute C_FAMILY of Fast_IP_Clock_mii_to_rmii_0_0_mii_to_rmii : entity is "artix7";
  attribute C_FIXED_SPEED : string;
  attribute C_FIXED_SPEED of Fast_IP_Clock_mii_to_rmii_0_0_mii_to_rmii : entity is "1'b1";
  attribute C_INCLUDE_BUF : integer;
  attribute C_INCLUDE_BUF of Fast_IP_Clock_mii_to_rmii_0_0_mii_to_rmii : entity is 2;
  attribute C_INSTANCE : string;
  attribute C_INSTANCE of Fast_IP_Clock_mii_to_rmii_0_0_mii_to_rmii : entity is "Fast_IP_Clock_mii_to_rmii_0_0";
  attribute C_SPEED_100 : string;
  attribute C_SPEED_100 of Fast_IP_Clock_mii_to_rmii_0_0_mii_to_rmii : entity is "1'b1";
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of Fast_IP_Clock_mii_to_rmii_0_0_mii_to_rmii : entity is "mii_to_rmii";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of Fast_IP_Clock_mii_to_rmii_0_0_mii_to_rmii : entity is "yes";
  attribute hdl : string;
  attribute hdl of Fast_IP_Clock_mii_to_rmii_0_0_mii_to_rmii : entity is "VHDL";
  attribute imp_netlist : string;
  attribute imp_netlist of Fast_IP_Clock_mii_to_rmii_0_0_mii_to_rmii : entity is "TRUE";
  attribute ip_group : string;
  attribute ip_group of Fast_IP_Clock_mii_to_rmii_0_0_mii_to_rmii : entity is "LOGICORE";
  attribute iptype : string;
  attribute iptype of Fast_IP_Clock_mii_to_rmii_0_0_mii_to_rmii : entity is "IP";
  attribute style : string;
  attribute style of Fast_IP_Clock_mii_to_rmii_0_0_mii_to_rmii : entity is "HDL";
end Fast_IP_Clock_mii_to_rmii_0_0_mii_to_rmii;

architecture STRUCTURE of Fast_IP_Clock_mii_to_rmii_0_0_mii_to_rmii is
  ...
  attribute BOX_TYPE : string;
  attribute BOX_TYPE of \BUFH_USED_1.RX_CLK_BUFH\ : label is "PRIMITIVE";
  attribute BOX_TYPE of \BUFH_USED_1.TX_CLK_BUFH\ : label is "PRIMITIVE";
  attribute sigis : string;
  attribute sigis of ref_clk : signal is "CLK";
  attribute sigis of rst_n : signal is "RST";
begin
\BUFH_USED_1.RX_CLK_BUFH\: unisim.vcomponents.BUFH
     port map (
      I => rmii2mac_rx_clk_bi,
      O => rmii2mac_rx_clk
    );
\BUFH_USED_1.TX_CLK_BUFH\: unisim.vcomponents.BUFH
     port map (
      I => rmii2mac_tx_clk_bi,
      O => rmii2mac_tx_clk
    );
\RMII_FIXED.I_RX\: entity work.Fast_IP_Clock_mii_to_rmii_0_0_rmii_rx_fixed
     port map (
...
\RMII_FIXED.I_TX\: entity work.Fast_IP_Clock_mii_to_rmii_0_0_rmii_tx_fixed
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Fast_IP_Clock_mii_to_rmii_0_0 is
  port (
    rst_n : in STD_LOGIC;
    ref_clk : in STD_LOGIC;
    mac2rmii_tx_en : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of Fast_IP_Clock_mii_to_rmii_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of Fast_IP_Clock_mii_to_rmii_0_0 : entity is "Fast_IP_Clock_mii_to_rmii_0_0,mii_to_rmii,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of Fast_IP_Clock_mii_to_rmii_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of Fast_IP_Clock_mii_to_rmii_0_0 : entity is "mii_to_rmii,Vivado 2018.3";
end Fast_IP_Clock_mii_to_rmii_0_0;

architecture STRUCTURE of Fast_IP_Clock_mii_to_rmii_0_0 is
  attribute C_FAMILY : string;
  attribute C_FAMILY of U0 : label is "artix7";
  attribute C_FIXED_SPEED : string;
  attribute C_FIXED_SPEED of U0 : label is "1'b1";
  attribute C_INCLUDE_BUF : integer;
  attribute C_INCLUDE_BUF of U0 : label is 2;
  attribute C_INSTANCE : string;
  attribute C_INSTANCE of U0 : label is "Fast_IP_Clock_mii_to_rmii_0_0";
  attribute C_SPEED_100 : string;
  ...
  attribute x_interface_parameter of ref_clk : signal is "XIL_INTERFACENAME clock, BOARD.ASSOCIATED_PARAM REF_CLK_BOARD_INTERFACE, FREQ_HZ 50000000, PHASE 0.0, CLK_DOMAIN /clk_wiz_0_clk_out1, INSERT_VIP 0";
...
begin
U0: entity work.Fast_IP_Clock_mii_to_rmii_0_0_mii_to_rmii
     port map (
